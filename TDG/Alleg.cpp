...
void ms(graphe &a1)
{
    ...
    do
    {
        std::cout<<"saisissez le poids du sommet à changer"<<std::endl;
        std::cin>>m_sommet;
...
void simulation(graphe &a1)
{
    ...
    /*///somme des poids de aretes et des sommets de tous les prédecesseurs (nourriture disponible)
        ...
        ///développement de la populatm_ar[x].m_pa*m_som[x].psion - le nombre de successeurs (tous les prédateurs)
    ...
    if(mouse_x>580+a1.gettemps() && mouse_x<620+a1.gettemps() && mouse_y > 640 && mouse_y < 670 && mouse_b==1)
        {
            while(mouse_b==1)
                {
                    ...
                    textprintf_centre_ex(buffer, font,680,680,makecol(255,255,255),12,"Année : %d",a1.gettemps());
        ...
        else
            {
                ...
                textprintf_centre_ex(page, font,680,680,makecol(255,255,255),12,"Année : %d",a1.gettemps());
            }
}
