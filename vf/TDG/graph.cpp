...
vector<int>graphe::cxt(int a)
{
    vector<int>f;
    int i;
    if(a==1)
            {
        if(m_som[0].actif==1 && m_som[1].actif==1)
        {
            m_som[1].actif=3;
            m_som[0].actif=2;
        }
        for (i =0; i<m_som.size(); i++)
        {
            if (m_som[i].actif==2)
            {
                f.push_back(i);
    ...
    if (a==2)
    {
        if(m_som[3].actif==1 && m_som[4].actif==1)
        {
            m_som[3].actif=3;
            m_som[4].actif=2;
        }
        if (m_som[1].actif==1 && m_som[2].actif==1)
        {
            m_som[1].actif=3;
            m_som[2].actif=2;
        }
        if (m_som[6].actif==1 && m_som[7].actif==1)
        {
            m_som[6].actif=3;
            m_som[7].actif=2;
        }
    ...
    if(a==3)
    {
         ...
         if(m_som[5].actif==1 && m_som[6].actif==1)
         {
            m_som[6].actif=3;
            m_som[5].actif=2;
         }
    ...
    if(a==4)
    {
        if(m_som[0].actif==1 && m_som[1].actif==1 && m_som[2].actif==1)
        {
            m_som[0].actif=3;
            m_som[1].actif=3;
            m_som[2].actif=2;
        ...
        if(m_som[4].actif==1 && m_som[5].actif==1)
         {
            m_som[4].actif=3;
            m_som[5].actif=2;
         }
